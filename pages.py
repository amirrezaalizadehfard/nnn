...
:root{--bg:#0a0e1a;--card:rgba(12,18,34,0.92);--accent:#5B7FFF;--accent2:#8AADFF;--text:#EAF0FF;--dim:#5A7A9E;--mid:#88B0D6;--border:rgba(91,127,255,0.2)}
...
.bg{position:fixed;inset:0;background:radial-gradient(ellipse 80% 60% at 50% 0%,rgba(91,127,255,0.12),transparent 70%),var(--bg);z-index:0}
.grid{position:fixed;inset:0;background-image:linear-gradient(rgba(91,127,255,0.03) 1px,transparent 1px),linear-gradient(90deg,rgba(91,127,255,0.03) 1px,transparent 1px);background-size:44px 44px;z-index:0}
.orb{position:fixed;border-radius:50%;filter:blur(90px);z-index:0;animation:fl 9s ease-in-out infinite}
.o1{width:380px;height:380px;background:rgba(91,127,255,0.08);top:-100px;right:-80px}
.o2{width:280px;height:280px;background:rgba(16,185,129,0.05);bottom:-60px;left:-60px;animation-delay:4s}
...
.card{background:var(--card);border:1px solid var(--border);border-radius:20px;padding:38px 34px 34px;backdrop-filter:blur(24px);box-shadow:0 0 80px rgba(91,127,255,0.06),0 20px 60px rgba(0,0,0,.5)}
.brand{display:flex;align-items:center;gap:14px;margin-bottom:28px}
.brand-img{width:48px;height:48px;border-radius:50%;overflow:hidden;border:1px solid rgba(139,92,246,0.3);box-shadow:0 0 20px rgba(139,92,246,0.25),0 0 40px rgba(91,127,255,0.15);flex-shrink:0}
...
.hint{display:flex;align-items:center;gap:10px;background:rgba(91,127,255,0.07);border:1px solid rgba(91,127,255,0.15);border-radius:10px;padding:10px 14px;margin-bottom:20px}
.hint-label{font-size:11px;color:var(--dim);flex:1}
.hint-val{font-family:ui-monospace,monospace;font-size:14px;font-weight:700;color:var(--accent);background:rgba(91,127,255,0.12);border:1px solid rgba(91,127,255,0.25);padding:3px 11px;border-radius:7px;cursor:pointer;transition:.15s;letter-spacing:.08em}
.hint-val:hover{background:rgba(91,127,255,0.22)}
...
input[type=password]:focus{border-color:rgba(91,127,255,.55);background:rgba(0,0,0,.4);box-shadow:0 0 0 4px rgba(91,127,255,0.08)}
...
.btn{width:100%;padding:13px;border-radius:11px;border:none;cursor:pointer;background:linear-gradient(135deg,#5B7FFF,#8B5CF6);color:#fff;font-family:inherit;font-size:14px;font-weight:600;display:flex;align-items:center;justify-content:center;gap:8px;box-shadow:0 4px 24px rgba(139,92,246,.35);transition:.2s;position:relative;overflow:hidden}
...
*{margin:0;padding:0;box-sizing:border-box}
:root{
  --bg:#080c1a;--bg2:#0e1428;--bg3:#151d38;
  --card:#0e1830;--card-b:rgba(91,127,255,0.12);--card-bh:rgba(91,127,255,0.28);
  --accent:#5B7FFF;--accent2:#8AADFF;--accent-d:rgba(91,127,255,0.1);
  --green:#2ECCAA;--green-bg:rgba(46,204,170,0.1);--green-t:#4AE0C0;
  --red:#EF5350;--red-bg:rgba(239,83,80,0.1);--red-t:#FB7A78;
  --amber:#F7C948;--amber-bg:rgba(247,201,72,0.1);--amber-t:#FAD96E;
  --purple:#A78BFA;--purple-bg:rgba(167,139,250,0.1);
  --t1:#EAF0FF;--t2:#88B0D6;--t3:#5A7A9E;
  --sidebar-w:248px;--radius:16px;
  --shadow:0 4px 28px rgba(0,0,0,0.4);
}
[data-theme="light"]{
  --bg:#F2F6FE;--bg2:#E8EFFA;--bg3:#D5E2F5;
  --card:#FFFFFF;--card-b:rgba(91,127,255,0.14);--card-bh:rgba(91,127,255,0.34);
  --accent:#4B6FE8;--accent2:#2E4FD6;--accent-d:rgba(75,111,232,0.08);
  --green:#1BA88A;--green-bg:rgba(27,168,138,0.08);--green-t:#11856C;
  --red:#D94444;--red-bg:rgba(217,68,68,0.08);--red-t:#AD2E2E;
  --amber:#D9A826;--amber-bg:rgba(217,168,38,0.08);--amber-t:#A8831A;
  --purple:#7C6EDB;--purple-bg:rgba(124,110,219,0.08);
  --t1:#0D1B36;--t2:#3D5A7E;--t3:#6D8AAE;
  --shadow:0 4px 24px rgba(20,40,90,0.1);
}
...
.logo-img{width:38px;height:38px;border-radius:50%;overflow:hidden;border:1px solid rgba(139,92,246,0.3);box-shadow:0 0 14px rgba(139,92,246,0.25),0 0 30px rgba(91,127,255,0.12);flex-shrink:0}
...
.nav-badge{margin-right:auto;background:rgba(91,127,255,0.15);color:var(--accent2);font-size:9px;padding:1px 6px;border-radius:20px;font-weight:700}
...
.bg-purple{background:var(--purple-bg);color:#C4B0FF}
...
.traf-range-tab.on{background:var(--accent);color:#fff;box-shadow:0 2px 8px rgba(91,127,255,.35)}
...
.btn-p{background:linear-gradient(135deg,#5B7FFF,#8B5CF6);color:#fff;box-shadow:0 2px 16px rgba(139,92,246,.3)}
.btn-p:hover{background:#4B6FE8;box-shadow:0 4px 20px rgba(91,127,255,.4)}
.btn-o{background:transparent;border:1px solid var(--card-b);color:var(--t2)}
.btn-o:hover{background:var(--accent-d);border-color:rgba(91,127,255,.3)}
.btn-g{background:var(--accent-d);color:var(--accent2);border:1px solid rgba(91,127,255,.15)}
.btn-g:hover{background:rgba(91,127,255,.22)}
.btn-d{background:var(--red-bg);color:var(--red-t);border:1px solid rgba(239,68,68,.2)}
.btn-d:hover{background:rgba(239,68,68,.2)}
.btn-pur{background:var(--purple-bg);color:#C4B0FF;border:1px solid rgba(167,139,250,.2)}
.btn-pur:hover{background:rgba(167,139,250,.22)}
.btn-amber{background:var(--amber-bg);color:var(--amber-t);border:1px solid rgba(247,201,72,.2)}
.btn-amber:hover{background:rgba(247,201,72,.22)}
...
.sr{display:flex;align-items:center;justify-content:space-between;padding:9px 0;border-bottom:1px solid rgba(91,127,255,0.05);font-size:12px}
...
.fi:focus,.fs:focus{border-color:rgba(91,127,255,.45);background:rgba(0,0,0,.25);box-shadow:0 0 0 4px rgba(91,127,255,0.06)}
.fs option{background:var(--bg2)}
[data-theme="light"] .fs option{background:#fff}
.cl{background:var(--accent-d);border:1px solid rgba(91,127,255,.15);border-radius:10px;padding:11px 13px;font-size:11px;color:var(--t2);display:flex;gap:9px;align-items:flex-start;line-height:1.8;margin-top:12px}
.cl i{font-size:15px;color:var(--accent);margin-top:1px;flex-shrink:0}
.cl.amber{background:var(--amber-bg);border-color:rgba(247,201,72,.2);color:var(--amber-t)}
...
.cp-head-icon{width:44px;height:44px;border-radius:13px;background:linear-gradient(135deg,var(--accent),var(--accent2));display:flex;align-items:center;justify-content:center;color:#fff;font-size:20px;flex-shrink:0;box-shadow:0 6px 20px rgba(91,127,255,.35)}
...
[data-theme="light"] .cp-block{background:rgba(75,111,232,.03)}
...
.cp-input-full:focus{border-color:rgba(91,127,255,.5);box-shadow:0 0 0 4px rgba(91,127,255,0.08)}
...
.chip:hover{background:rgba(91,127,255,.18);color:var(--accent2)}
.chip.active{background:var(--accent);color:#fff;border-color:var(--accent);box-shadow:0 3px 12px rgba(91,127,255,.3)}
...
.proto-card.active{border-color:var(--accent);background:var(--accent-d);box-shadow:0 0 0 4px rgba(91,127,255,0.08)}
...
.cp-submit-btn{background:linear-gradient(135deg,var(--accent),var(--accent2));color:#fff;border:none;border-radius:13px;padding:13px 26px;font-family:inherit;font-size:13px;font-weight:800;cursor:pointer;display:flex;align-items:center;gap:8px;box-shadow:0 6px 22px rgba(91,127,255,.35);transition:.18s;white-space:nowrap}
.cp-submit-btn:hover{transform:translateY(-2px);box-shadow:0 10px 30px rgba(91,127,255,.45)}
...
.srv-hero-icon{width:50px;height:50px;border-radius:14px;background:linear-gradient(135deg,var(--accent),var(--accent2));display:flex;align-items:center;justify-content:center;color:#fff;font-size:22px;flex-shrink:0;box-shadow:0 6px 20px rgba(91,127,255,.35)}
...
[data-theme="light"] .srv-tile{background:rgba(75,111,232,.03)}
...
.pw-hero-icon{width:50px;height:50px;border-radius:14px;background:linear-gradient(135deg,var(--purple),#6D48D6);display:flex;align-items:center;justify-content:center;color:#fff;font-size:22px;flex-shrink:0;box-shadow:0 6px 20px rgba(167,139,250,.35)}
...
.pw-input:focus{border-color:rgba(167,139,250,.5);box-shadow:0 0 0 4px rgba(167,139,250,0.08)}
...
.pw-submit{width:100%;justify-content:center;background:linear-gradient(135deg,var(--purple),#6D48D6);color:#fff;border:none;border-radius:12px;padding:12px;font-family:inherit;font-size:13px;font-weight:800;cursor:pointer;display:flex;align-items:center;gap:8px;box-shadow:0 6px 20px rgba(167,139,250,.32);transition:.18s}
.pw-submit:hover{transform:translateY(-2px);box-shadow:0 10px 28px rgba(167,139,250,.42)}
...
.conn-live-badge{display:flex;align-items:center;gap:6px;font-size:10.5px;font-weight:700;color:var(--green-t);background:var(--green-bg);padding:5px 12px;border-radius:20px;border:1px solid rgba(46,204,170,.2)}
...
.conn-card-v2-glow{position:absolute;top:-40px;left:-40px;width:140px;height:140px;background:radial-gradient(circle,rgba(46,204,170,.1),transparent 70%);pointer-events:none}
.conn-card-v2-top{display:flex;align-items:center;gap:12px;padding:16px 17px 13px;position:relative;z-index:1}
.conn-avatar{width:42px;height:42px;border-radius:13px;background:linear-gradient(135deg,var(--green),#1BA88A);display:flex;align-items:center;justify-content:center;color:#fff;font-size:18px;flex-shrink:0;position:relative;box-shadow:0 4px 16px rgba(46,204,170,.3)}
...
.sub-url{font-family:ui-monospace,monospace;font-size:10.5px;color:#C4B0FF;word-break:break-all;flex:1}
...
.subs-search input:focus{border-color:rgba(167,139,250,.5);box-shadow:0 0 0 4px rgba(167,139,250,0.08)}
...
.sub-card-icon{width:46px;height:46px;border-radius:14px;background:linear-gradient(135deg,var(--purple),#6D48D6);display:flex;align-items:center;justify-content:center;color:#fff;font-size:20px;flex-shrink:0;box-shadow:0 6px 18px rgba(167,139,250,.35)}
...
[data-theme="light"] .sub-card-stats{background:rgba(124,110,219,.03)}
...
.sub-card-url-text{font-family:ui-monospace,monospace;font-size:9.5px;color:#C4B0FF;flex:1;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
...
.sub-card-url-copy:hover{color:#C4B0FF;transform:scale(1.1)}
...
.modal-v2-icon{width:42px;height:42px;border-radius:13px;background:linear-gradient(135deg,var(--purple),#6D48D6);display:flex;align-items:center;justify-content:center;color:#fff;font-size:19px;margin-bottom:10px;position:relative;z-index:1;box-shadow:0 8px 20px rgba(167,139,250,.4)}
...
[data-theme="light"] .modal-v2-input{background:rgba(124,110,219,.04)}
.modal-v2-input::placeholder{color:var(--t3)}
.modal-v2-input:focus{border-color:rgba(167,139,250,.55);box-shadow:0 0 0 4px rgba(167,139,250,0.1);background:rgba(0,0,0,.28)}
[data-theme="light"] .modal-v2-input:focus{background:#fff}
.modal-v2-input:focus~i{color:var(--purple)}
.modal-v2-hint{background:rgba(91,127,255,.08);border:1px solid rgba(91,127,255,.18);border-radius:11px;padding:9px 12px;font-size:10px;color:var(--t2);display:flex;gap:7px;align-items:flex-start;line-height:1.6;margin-top:2px}
...
.modal-v2-btn-submit{flex:1;justify-content:center;padding:10px;border-radius:11px;background:linear-gradient(135deg,var(--purple),#6D48D6);color:#fff;border:none;font-family:inherit;font-size:12px;font-weight:800;cursor:pointer;display:flex;align-items:center;gap:6px;box-shadow:0 6px 20px rgba(167,139,250,.4);transition:.18s}
.modal-v2-btn-submit:hover{transform:translateY(-2px);box-shadow:0 10px 28px rgba(167,139,250,.5)}
...
.lmodal-icon{width:44px;height:44px;border-radius:13px;background:linear-gradient(135deg,var(--accent),var(--accent2));display:flex;align-items:center;justify-content:center;color:#fff;font-size:19px;flex-shrink:0;box-shadow:0 6px 18px rgba(91,127,255,.35)}
...
.lmodal-search input:focus{border-color:rgba(91,127,255,.5);box-shadow:0 0 0 4px rgba(91,127,255,0.08)}
...
.lmodal-qbtn:hover{background:rgba(91,127,255,.2)}
...
.lrow-v2.checked{background:rgba(91,127,255,.1);border-color:rgba(91,127,255,.25)}
...
.lrow{display:flex;align-items:center;gap:8px;padding:7px 0;border-bottom:1px solid rgba(91,127,255,.05)}
...
.toast.ok{border-color:rgba(46,204,170,.3);background:var(--green-bg);color:var(--green-t)}
...
.cfg-uuid-mini:hover{background:rgba(91,127,255,.2)}
...
.ubar{height:5px;border-radius:4px;background:rgba(91,127,255,0.1);overflow:hidden}
...
.pc-xhttp{background:var(--purple-bg);color:#C4B0FF}
...
.log-item{display:flex;gap:12px;padding:11px 0;border-bottom:1px solid rgba(91,127,255,.05);position:relative}
...
.erow{padding:9px 0;border-bottom:1px solid rgba(91,127,255,.05)}
    ...
    el.innerHTML=subs.map(s=>`
      <div style="padding:13px 15px;background:var(--accent-d);border:1px solid var(--card-b);border-radius:10px;margin-bottom:8px;display:flex;align-items:center;justify-content:space-between;gap:10px;flex-wrap:wrap">
        <div>
          ...
          <div style="font-family:ui-monospace,monospace;font-size:10px;color:#C4B0FF">${esc(s.sub_url)}</div>
...
function checkPwStrength(val){
  ...
  const colors=['#EF4444','#F59E0B','#5B7FFF','#2ECCAA'],labels=['خیلی ضعیف','ضعیف','متوسط','قوی'];
...
function initCharts(){
  ...
  const grad1=makeGradient(c1,'rgba(91,127,255,.38)','rgba(91,127,255,0)');
  const opts={
    ...
    plugins:{
      ...
      tooltip:{
        backgroundColor:'rgba(14,24,48,.96)',borderColor:'rgba(91,127,255,.3)',borderWidth:1,
        titleColor:'#EAF0FF',bodyColor:'#88B0D6',padding:11,cornerRadius:10,displayColors:false,
    ...
    scales:{
      x:{grid:{display:false},border:{display:false},ticks:{color:'#5A7A9E',font:{size:9,family:'Vazirmatn'}}},
      y:{grid:{color:'rgba(91,127,255,.06)'},border:{display:false},ticks:{color:'#5A7A9E',font:{size:9,family:'Vazirmatn'},callback:v=>v+' MB'}}
    },
    elements:{line:{capBezierPoints:true}}
  };
  const ds1={label:'MB',data:[],borderColor:'#5B7FFF',backgroundColor:grad1,fill:true,tension:.42,pointRadius:0,pointHoverRadius:6,pointHoverBackgroundColor:'#5B7FFF',pointHoverBorderColor:'#fff',pointHoverBorderWidth:2,borderWidth:2.5};
  ...
  const gradFill3=makeGradientV2(c3ctx,'rgba(91,127,255,.45)','rgba(91,127,255,.08)','rgba(91,127,255,0)');
  ch3=new Chart(document.getElementById('ch3'),{
    type:'line',
    data:{labels:[],datasets:[
      {label:'مصرف',data:[],borderColor:'#5B7FFF',backgroundColor:gradFill3,fill:true,tension:.45,pointRadius:0,pointHoverRadius:7,pointHoverBackgroundColor:'#fff',pointHoverBorderColor:'#5B7FFF',pointHoverBorderWidth:3,borderWidth:3,order:2},
      {label:'میانگین',data:[],borderColor:'#F7C948',borderDash:[6,5],borderWidth:1.6,pointRadius:0,fill:false,tension:0,order:1}
    ]},
    options:{
      responsive:true,maintainAspectRatio:false,
      interaction:{mode:'index',intersect:false},
      plugins:{
        legend:{display:false},
        tooltip:{
          backgroundColor:'rgba(14,24,48,.97)',borderColor:'rgba(91,127,255,.35)',borderWidth:1,
          titleColor:'#EAF0FF',bodyColor:'#9DC3E8',padding:13,cornerRadius:12,displayColors:true,boxPadding:4,
      ...
      scales:{
        x:{grid:{display:false},border:{display:false},ticks:{color:'#5A7A9E',font:{size:9.5,family:'Vazirmatn'},maxRotation:0}},
        y:{grid:{color:'rgba(91,127,255,.05)'},border:{display:false},ticks:{color:'#5A7A9E',font:{size:9.5,family:'Vazirmatn'},callback:v=>v+' MB'}}
      }
    }
  });
  ...
  ch2=new Chart(document.getElementById('ch2'),{
    ...
    data:{labels:['VLESS/WS','XHTTP Ultra','HTTP Proxy'],datasets:[{
      data:[55,35,10],
      backgroundColor:['#5B7FFF','#2ECCAA','#A78BFA'],
      borderColor:getComputedStyle(document.documentElement).getPropertyValue('--card')||'#0e1830',
    ...
    options:{
      ...
      plugins:{
        ...
        tooltip:{backgroundColor:'rgba(14,24,48,.96)',borderColor:'rgba(91,127,255,.3)',borderWidth:1,padding:10,cornerRadius:10,bodyFont:{family:'Vazirmatn'},titleFont:{family:'Vazirmatn'}}
      }
    }
  });
}
let ws;
function wsLog(c,m){const l=document.getElementById('ws-log'),p=document.createElement('p');const colors={ok:'#2ECCAA',err:'#EF5350',info:'#88B0D6',sent:'#F7C948'};p.style.color=colors[c]||'#fff';p.textContent='['+new Date().toLocaleTimeString('fa-IR')+'] '+m;l.appendChild(p);l.scrollTop=l.scrollHeight}
...
:root{{
  --bg:#080c1a;--bg2:#0e1428;--bg3:#151d38;
  --card:#0e1830;--card-b:rgba(91,127,255,0.1);--card-bh:rgba(91,127,255,0.28);
  --accent:#5B7FFF;--accent2:#8AADFF;--accent-d:rgba(91,127,255,0.08);
  --green:#2ECCAA;--green-bg:rgba(46,204,170,0.08);--green-t:#4AE0C0;
  --red:#EF5350;--red-bg:rgba(239,83,80,0.08);--red-t:#FB7A78;
  --amber:#F7C948;--amber-bg:rgba(247,201,72,0.08);--amber-t:#FAD96E;
  --purple:#A78BFA;--purple-bg:rgba(167,139,250,0.08);--purple-t:#C4B0FF;
  --t1:#EAF0FF;--t2:#88B0D6;--t3:#5A7A9E;
...
[data-theme="light"]{{
  --bg:#F2F6FE;--bg2:#E8EFFA;--bg3:#D5E2F5;
  --card:#FFFFFF;--card-b:rgba(91,127,255,0.14);--card-bh:rgba(91,127,255,0.32);
  --accent:#4B6FE8;--accent2:#2E4FD6;--accent-d:rgba(75,111,232,0.06);
  --green:#1BA88A;--green-bg:rgba(27,168,138,0.06);--green-t:#11856C;
  --red:#D94444;--red-bg:rgba(217,68,68,0.06);--red-t:#AD2E2E;
  --amber:#D9A826;--amber-bg:rgba(217,168,38,0.06);--amber-t:#A8831A;
  --purple:#7C6EDB;--purple-bg:rgba(124,110,219,0.06);
  --t1:#0D1B36;--t2:#3D5A7E;--t3:#6D8AAE;
...
.bg-fx{{position:fixed;inset:0;background:radial-gradient(ellipse 70% 45% at 50% -8%,rgba(91,127,255,0.12),transparent 62%),var(--bg);z-index:0;pointer-events:none;transition:background .35s}}
.grid-fx{{position:fixed;inset:0;background-image:linear-gradient(rgba(91,127,255,0.025) 1px,transparent 1px),linear-gradient(90deg,rgba(91,127,255,0.025) 1px,transparent 1px);background-size:46px 46px;z-index:0;pointer-events:none}}
...
.brand-img{{width:40px;height:40px;border-radius:50%;overflow:hidden;border:1px solid rgba(139,92,246,0.3);box-shadow:0 0 14px rgba(139,92,246,0.25),0 0 30px rgba(91,127,255,0.12);flex-shrink:0}}
.brand-img img{{width:100%;height:100%;object-fit:cover}}
...
.sub-info::before{{content:'';position:absolute;top:0;right:0;width:160px;height:160px;background:radial-gradient(circle at top right,rgba(91,127,255,.1),transparent 70%);pointer-events:none}}
...
.copy-all-bar{{display:flex;align-items:center;gap:12px;background:linear-gradient(120deg,var(--accent) 0%,#3A5FD6 100%);border-radius:18px;padding:16px 19px;margin-bottom:18px;box-shadow:0 10px 30px rgba(91,127,255,.28);flex-wrap:wrap}}
...
.copy-all-btn{{background:#fff;color:#2E4FD6;border:none;border-radius:12px;padding:10px 19px;font-family:inherit;font-size:12.5px;font-weight:800;cursor:pointer;display:flex;align-items:center;gap:6px;transition:.18s;white-space:nowrap}}
...
.ubar{{height:6px;border-radius:4px;background:rgba(91,127,255,0.1);overflow:hidden;margin-bottom:5px}}
...
[data-theme="light"] .cfg-vless{{background:rgba(75,111,232,.05)}}
...
.btn i{{font-size:13px}}
.btn-p{{background:linear-gradient(135deg,#5B7FFF,#8B5CF6);color:#fff;box-shadow:0 3px 16px rgba(139,92,246,.35)}}
.btn-p:hover{{background:var(--accent2)}}
.btn-g{{background:var(--accent-d);color:var(--accent2);border:1px solid rgba(91,127,255,.16)}}
.btn-g:hover{{background:rgba(91,127,255,.2)}}
.btn-pur{{background:var(--purple-bg);color:var(--purple-t);border:1px solid rgba(167,139,250,.2)}}
.btn-pur:hover{{background:rgba(167,139,250,.22)}}
...
.lock-banner{{background:linear-gradient(150deg,rgba(91,127,255,.16),rgba(91,127,255,.02) 70%);padding:38px 30px 26px;position:relative}}
...
[data-theme="light"] .lock-inp{{background:rgba(75,111,232,.04)}}
...
.toast.show{{opacity:1;transform:translateX(-50%) translateY(0)}}
.toast.ok{{border-color:rgba(46,204,170,.35);background:var(--green-bg);color:var(--green-t)}}
